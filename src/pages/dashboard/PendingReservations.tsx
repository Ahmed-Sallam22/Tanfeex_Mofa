  ...
  return (
    <div>
            ...
            <div className="text-center max-w-md px-6">
              ...
              <div className="space-y-3">
                <h3 className="text-red-800 font-bold text-xl">
                  {t("pendingReservations.unableToLoadTransfers")}
                </h3>
                <p className="text-red-600 text-sm leading-relaxed">
                  {t("pendingReservations.connectionTrouble")}
                </p>
                <div className="flex flex-col sm:flex-row gap-2 justify-center mt-6">
                  ...
                  >
                    <span className="flex items-center justify-center gap-2">
                      ...
                      {t("pendingReservations.tryAgain")}
                    </span>
                  </button>
                  <button
                  ...
                  >
                    {t("pendingReservations.resetFilters")}
                  </button>
                </div>
              </div>
            </div>
      ...
      <SharedModal
        ...
        title={t("pendingReservations.transferStatusPipeline")}
        size="lg"
      >
        <div className="p-6">
          {isLoadingStatus ? (
            <div className="flex justify-center items-center py-12">
              <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-blue-600"></div>
              <span className="ml-2 text-gray-600">
                {t("pendingReservations.loadingStatus")}
              </span>
            </div>
          ) : statusError ? (
            <div className="flex justify-center items-center py-12">
              <div className="text-center">
                ...
                <p className="text-gray-600">
                  {t("pendingReservations.failedToLoadStatus")}
                </p>
              </div>
            </div>
          ) : statusData ? (
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <h4 className="text-md font-semibold text-gray-800 mb-4">
                  {t("pendingReservations.approvalStages")}
                </h4>
                        ...
                        <div className="bg-white rounded-lg ">
                          <div className="flex items-center justify-between mb-2">
                            ...
                            <span className="text-xs text-gray-500">
                              {t("pendingReservations.stage")} {stage.order_index}
                            </span>
                          </div>
                          ...
                          <div className="flex items-center justify-between text-sm text-gray-600">
                            <span>
                              <span className="font-medium">
                                {t("pendingReservations.decisionPolicy")}:
                              </span>{" "}
                          ...
                          <div className="flex items-center mt-3 text-sm">
                            ...
                            stage.status === "active" ? (
                              <div className="flex items-center text-green-600">
                                ...
                                <span className="font-medium">
                                  {t("pendingReservations.approved")}
                                </span>
                              </div>
                            ) : stage.status === "pending" ? (
                              <div className="flex items-center text-yellow-600">
                                ...
                                <span className="font-medium">
                                  {t("pendingReservations.awaitingApproval")}
                                </span>
                              </div>
                            ) : stage.status === "rejected" ? (
                              <div className="flex items-center text-red-600">
                                ...
                                <span className="font-medium">
                                  {t("pendingReservations.rejected")}
                                </span>
                              </div>
                            ) : (
                              <div className="flex items-center text-blue-700">
                                ...
                                <span className="font-medium">
                                  {t("pendingReservations.inProgress")}
                                </span>
                              </div>
                            )}
                          </div>
            ...
            <div className="text-center py-12 text-gray-500">
              ...
              <p>{t("pendingReservations.noStatusAvailable")}</p>
            </div>
          )}
