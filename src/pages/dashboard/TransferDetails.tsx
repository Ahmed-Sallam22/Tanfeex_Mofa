...
export default function TransferDetails() {
  ...
  // Track the first row's segment 11 (Mofa Budget) value
  useEffect(() => {
  ...
  // For segments other than segment 11, use filtered data if applicable
  ...
  // Build segment data map - use filtered data for non-first rows in internal transfers
    ...
    requiredSegments.forEach((segment) => {
      ...
      dynamicColumns.push({
        ...
        render: (_, row) => {
          ...
          // Get options based on row context
